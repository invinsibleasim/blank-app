...
encapsulant_transmission = st.sidebar.slider("Encapsulant Transmission (%)", 92.0, 94.0, 98.0, 94.0, 0.5, help="Encapsulant: 94%")
...
ribbon_width = st.sidebar.number_input("Ribbon Width (mm)", min_value=0.8, max_value=4.5, value=1.5, step=0.1)
